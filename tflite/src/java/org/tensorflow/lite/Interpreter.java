...
public final class Interpreter {
  ...
  public static class Options {
    ...
    public Options setUseNNAPI(boolean useNNAPI) {
      this.useNNAPI = new Boolean(useNNAPI);
      return this;
    }
    ...
    public Options setAllowFp16PrecisionForFp32(boolean allow) {
      this.allowFp16PrecisionForFp32 = new Boolean(allow);
      return this;
    }
    ...
    public Options setAllowBufferHandleOutput(boolean allow) {
      this.allowBufferHandleOutput = new Boolean(allow);
      return this;
    }
    ...
    public Options setCancellable(boolean allow) {
      this.allowCancellation = new Boolean(allow);
      return this;
    }
    ...
    public Options setUseXNNPACK(boolean useXNNPACK) {
      this.useXNNPACK = new Boolean(useXNNPACK);
      return this;
    }
    ...
    Boolean useXNNPACK;
    final Vector delegates = new Vector();
  }

  /**
   * Initializes an {@code Interpreter}.
   *
   * @param absoluteFilePath a file name of a pre-trained TF Lite model.
   * @throws IllegalArgumentException if {@code modelFile} does not encode a valid TensorFlow Lite
   *     model.
   */
  public Interpreter(String  absoluteFilePath) {
    this(absoluteFilePath, /*options = */ null);
  }
   ...
   *     model.
   */
  public Interpreter(String absoluteFilePath, Options options) {
    wrapper = new NativeInterpreterWrapper(absoluteFilePath, options);
  ...
  public void run(Object input, Object output) {
    ...
    outputs.put(new Integer(0), output);
  ...
  public void runForMultipleInputsOutputs(
      Object[] inputs, Hashtable outputs) {
    checkNotClosed();
   ...
   */
  public void runSignature(
      Hashtable inputs, Hashtable outputs) {
    checkNotClosed();
