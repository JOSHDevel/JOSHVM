...
import com.sun.cldc.io.HttpUrl;
...
import com.sun.cldc.util.Properties;
...
public class Protocol extends com.sun.midp.io.j2me.http.Protocol
    ...
    protected StreamConnection connect() throws IOException {
        StreamConnection sc;
        String httpsTunnel;
        com.sun.cldc.io.j2me.socket.Protocol tcpConnection;
        ...
        sc = connectionPool.get(protocol,
                                url.host, url.port);
        ...
        tcpConnection =
            new com.sun.cldc.io.j2me.socket.Protocol();

        // check to see if a protocol is specified for the tunnel
        httpsTunnel = System.getProperty("com.sun.midp.io.http.proxy");
        if (httpsTunnel != null) {
            ...
            tcpConnection.openPrim("//" + hostAndPort);
    ...
    public SecurityInfo getSecurityInfo() throws IOException {
        ...
        if (sslConnection == null) {
            ...
            return ((SSLBouncyCastleStreamConnection)sc).getSecurityInfo();
        }
